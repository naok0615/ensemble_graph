...
class AttLoss(_LossBase):
    ...
    def forward(self, target_output, source_output, label_id, log=None, **kwargs):
        ...
        for i in range(len(student_att)):
            ...
            student_att_top_11[i] = torch.cat((student_att[i][ x_1+16*y_id[0] : x_2+16*y_id[0] ],
                                               student_att[i][ x_1+16*y_id[1] : x_2+16*y_id[1] ],
                                               student_att[i][ x_1+16*y_id[2] : x_2+16*y_id[2] ],
                                               student_att[i][ x_1+16*y_id[3] : x_2+16*y_id[3] ],
                                               student_att[i][ x_1+16*y_id[4] : x_2+16*y_id[4] ],
                                               student_att[i][ x_1+16*y_id[5] : x_2+16*y_id[5] ],
                                               student_att[i][ x_1+16*y_id[6] : x_2+16*y_id[6] ],
                                               student_att[i][ x_1+16*y_id[7] : x_2+16*y_id[7] ],
                                               student_att[i][ x_1+16*y_id[8] : x_2+16*y_id[8] ],
                                               student_att[i][ x_1+16*y_id[9] : x_2+16*y_id[9] ],
                                               student_att[i][ x_1+16*y_id[10] : x_2+16*y_id[10] ]
                                              ))
            teacher_att_top_11[i] = torch.cat((teacher_att[i][ x_1+16*y_id[0] : x_2+16*y_id[0] ],
                                               teacher_att[i][ x_1+16*y_id[1] : x_2+16*y_id[1] ],
                                               teacher_att[i][ x_1+16*y_id[2] : x_2+16*y_id[2] ],
                                               teacher_att[i][ x_1+16*y_id[3] : x_2+16*y_id[3] ],
                                               teacher_att[i][ x_1+16*y_id[4] : x_2+16*y_id[4] ],
                                               teacher_att[i][ x_1+16*y_id[5] : x_2+16*y_id[5] ],
                                               teacher_att[i][ x_1+16*y_id[6] : x_2+16*y_id[6] ],
                                               teacher_att[i][ x_1+16*y_id[7] : x_2+16*y_id[7] ],
                                               teacher_att[i][ x_1+16*y_id[8] : x_2+16*y_id[8] ],
                                               teacher_att[i][ x_1+16*y_id[9] : x_2+16*y_id[9] ],
                                               teacher_att[i][ x_1+16*y_id[10] : x_2+16*y_id[10] ]
                                              ))
            # 7*7 -----------------------------------------------------------------------------------
            y_id, x_1, x_2 = teacher_att_top_index[i][1]
            student_att_top_7[i] = torch.cat((student_att[i][ x_1+16*y_id[0] : x_2+16*y_id[0] ],
                                              student_att[i][ x_1+16*y_id[1] : x_2+16*y_id[1] ],
                                              student_att[i][ x_1+16*y_id[2] : x_2+16*y_id[2] ],
                                              student_att[i][ x_1+16*y_id[3] : x_2+16*y_id[3] ],
                                              student_att[i][ x_1+16*y_id[4] : x_2+16*y_id[4] ],
            ...
            teacher_att_top_7[i] = torch.cat((teacher_att[i][ x_1+16*y_id[0] : x_2+16*y_id[0] ],
                                              teacher_att[i][ x_1+16*y_id[1] : x_2+16*y_id[1] ],
                                              teacher_att[i][ x_1+16*y_id[2] : x_2+16*y_id[2] ],
                                              teacher_att[i][ x_1+16*y_id[3] : x_2+16*y_id[3] ],
                                              teacher_att[i][ x_1+16*y_id[4] : x_2+16*y_id[4] ],
            ...
            student_att_top_3[i] = torch.cat((student_att[i][ x_1+16*y_id[0] : x_2+16*y_id[0] ],
                                              student_att[i][ x_1+16*y_id[1] : x_2+16*y_id[1] ],
                                              student_att[i][ x_1+16*y_id[2] : x_2+16*y_id[2] ],
                                             ))
            teacher_att_top_3[i] = torch.cat((teacher_att[i][ x_1+16*y_id[0] : x_2+16*y_id[0] ],
                                              teacher_att[i][ x_1+16*y_id[1] : x_2+16*y_id[1] ],
                                              teacher_att[i][ x_1+16*y_id[2] : x_2+16*y_id[2] ],
                                             ))
