...
if args.dataset == "StanfordDogs_split":
    ...
    DATA_PATH  = '/workspace/work/KTG_Ensemble_224/dataset/StanfordCars/' #"./dataset/StanfordCars/"
    NUM_CLASS  = 196
    SCHEDULE   = [150,225]
    EPOCHS     = 300
    BATCH_SIZE = 16
    ...
    DATA_PATH  = '/workspace/work/KTG_Ensemble_224/dataset/cub2011/' #"./dataset/cub2011/"
    NUM_CLASS  = 200
    SCHEDULE   = [150,225]
    EPOCHS     = 300
    BATCH_SIZE = 16
